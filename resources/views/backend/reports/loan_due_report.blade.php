				...
				<table class="table table-bordered report-table">
					...
					@if(isset($report_data))
						...
						@foreach($report_data as $repayment)
							@php $grand_total += $repayment->total_due; @endphp
							<tr>
						...
						<tr class="font-weight-bold">
							<td colspan="3" class="text-right">{{ _lang('Grand Total') }}</td>
							<td class="text-right">{{ decimalPlace($grand_total, currency(get_base_currency())) }}</td>
						</tr>
					@endif
				    </tbody>
				</table>
