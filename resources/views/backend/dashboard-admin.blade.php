			...
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						<h5>{{ _lang('Total Capital') }}</h5>
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($total_capital, currency(get_base_currency())) }}</b></h4>
					</div>
					<div>
			...
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						...
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($total_paid, currency(get_base_currency())) }}</b></h4>
					</div>
					<div>
	...
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 warning-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						<h5>{{ _lang('Remaining Balance') }}</h5>
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($total_balance, currency(get_base_currency())) }}</b></h4>
					</div>
					<div>
	...
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 primary-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						<h5>{{ _lang('Total Interest Expected') }}</h5>
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($total_expected_interest, currency(get_base_currency())) }}</b></h4>
					</div>
					<div>
	...
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 danger-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						<h5>{{ _lang('Remaining Interest') }}</h5>
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($remaining_interest, currency(get_base_currency())) }}</b></h4>
					</div>
					<div>
